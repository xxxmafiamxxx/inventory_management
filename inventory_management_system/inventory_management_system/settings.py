...
ALLOWED_HOSTS = [
    'invmanagement-geajd4gubhghcyfz.francecentral-01.azurewebsites.net',  # Your Azure Web App
    'localhost',
    '127.0.0.1',
    '[::1]',
]

# Add CSRF trusted origins for Azure
CSRF_TRUSTED_ORIGINS = [
    'https://invmanagement-geajd4gubhghcyfz.francecentral-01.azurewebsites.net',  # Add your app's domain
]
